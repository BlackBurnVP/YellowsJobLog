...
class ReportsAdapter(private var reports:MutableList<JobLogPOJO>? = ArrayList()) : RecyclerView.Adapter<ReportsAdapter.ViewHolder>(){
...
//            }
    ...
    fun updateRecycler(newList: MutableList<JobLogPOJO>){
        reports!!.clear()
